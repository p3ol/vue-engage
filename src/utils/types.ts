...
export interface EngageContextValue {
  /**
   * Your poool app ID
   *
   * More infos:
   * https://www.poool.dev/docs/engage/javascript/installation
   */
  appId?: string;
  /**
   * Your poool engage config options
   *
   * More infos:
   * https://www.poool.dev/docs/engage/javascript/configuration
   */
  config?: Poool.EngageConfigOptions;
  /**
   * Your poool engage texts options
   *
   * More infos:
   * https://www.poool.dev/docs/engage/javascript/texts
  */
  texts?: Poool.EngageTexts;
  /**
   * Your poool engage variables options
   *
   * More infos:
   * https://www.poool.dev/docs/engage/javascript/variables
   */
  variables?: Poool.EngageVariables;
  /**
   * Your poool engage events
   *
   * More infos: https://www.poool.dev/docs/engage/javascript/events
   */
  events?: { [key in Poool.EngageEventsList] ?: EngageEvents[key] };
  /**
   * The poool engage script url
   *
   * More infos:
   * https://www.poool.dev/docs/engage/javascript/installation
   */
